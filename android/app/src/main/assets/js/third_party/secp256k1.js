// 第三方库原样内置：@noble/secp256k1 3.2.0（MIT，https://github.com/paulmillr/noble-secp256k1）。
// 只用它的 BIP340 Schnorr 签名给公共中继的 Nostr 事件签名 —— WebCrypto 不支持 secp256k1。
// 升级时整文件替换，不要手改。许可证全文见同目录 secp256k1.LICENSE。
